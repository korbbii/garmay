...
// Assuming you have received the form data from a POST request
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['confirm_payment'])) {
    ...
    // SQL query to insert data into the flights table
    $sql = "INSERT INTO flights (name, email, nationality, airline, airport, departure, arrival)
            VALUES ('$name', '$email', '$nationality', '$airline', '$airport', '$departure', '$arrival')";
...
.passenger-row:last-child {
    margin-bottom: 0; /* Remove margin bottom from last row */
}
...
<section id="additional-search-boxes">
    ...
    <div class="popup-content">
        ...
        <form id="passengerForm" class="form-inside-popup">
            ...
            <div class="form-group">
                <select id="passengerClass" name="passengerClass">
            ...
            <div class="passenger-row">
                <div class="form-group">
                    ...
                    <input type="number" id="infant" name="infant" min="0" value="0">
                </div>
                <div class="form-group">
